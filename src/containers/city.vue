...
<script>
import Header from "comp/city/header.vue";
import SearchBox from "comp/city/search-box.vue";
import List from "comp/city/list.vue";
import Alphabet from "comp/city/alphabet.vue";
export default {
  created() {
    this.getData();
  },
